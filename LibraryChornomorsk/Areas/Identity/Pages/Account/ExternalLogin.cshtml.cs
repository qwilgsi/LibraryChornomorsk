...
namespace LibraryChornomorsk.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = "Ошибка загрузки информации о входе.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("{Name} вошел с провайдером {LoginProvider}.", info.Principal.Identity.Name, info.LoginProvider);
        ...
        private LibraryUser CreateUser() => new LibraryUser();
        private IUserEmailStore<LibraryUser> GetEmailStore() => (IUserEmailStore<LibraryUser>)_userStore;
    }
}
